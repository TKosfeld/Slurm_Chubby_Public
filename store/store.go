// Adapted From https://github.com/otoolep/hraftd/blob/master/store/store.go
...
/*
Opens the store. If enableSingle is set, and there are no existing peers,
...
/* Joins a node, identified by nodeID and located at addr, to this store.
The node must be ready to respond to Raft communications at that address.
This function should be called by the leader */
